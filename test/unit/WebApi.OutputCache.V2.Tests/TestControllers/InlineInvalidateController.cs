...
{
    public class InlineInvalidateController
        : ApiController
    {
        ...
        public void Post()
        {
            ...
            cache.RemoveStartsWith(Configuration.CacheOutputConfiguration().MakeBaseCacheKey(GetType().FullName, nameof(Get_c100_s100)));
